...
2. Descarga los binarios base del servidor original de *Minecraft Bedrock* directamente desde el dashboard o colócalos tú mismo al lado de estos `.py` y `.ps1`.
...
2. La primera vez que abras el *Dashboard* se generará un archivo `config.json` en la misma carpeta. Ábrelo con el block de notas.
